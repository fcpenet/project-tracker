...
export const mockTasks: Task[] = [
  {
    id: '1', epicId: '10', title: 'Build landing page', description: 'Hero section + CTA',
  ...
  {
    id: '2', epicId: '10', title: 'Setup CI/CD', description: undefined,
  ...
  {
    id: '3', epicId: '11', title: 'Write unit tests',
